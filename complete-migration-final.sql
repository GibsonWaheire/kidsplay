-- =====================================================
-- COMPLETE MIGRATION SCRIPT FOR KIDSPLAY CONNECT (FINAL)
-- =====================================================
-- This migration is designed to be completely safe and handle existing tables
...
-- Testimonials table (include all columns from the start)
...
-- =====================================================
-- ADD MISSING COLUMNS (BEFORE INDEXES!)
-- =====================================================

-- Add role column to user_profiles if it doesn't exist (for existing installations)
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS role user_role DEFAULT 'user';

-- Note: testimonials columns (rating, featured) are now included in the CREATE TABLE statement above
-- These ALTER statements are kept for backwards compatibility with existing installations
...
-- Testimonials indexes (NOW the columns exist!)
...
-- =====================================================
-- RLS POLICIES (SAFE - NO DROP OPERATIONS)
-- =====================================================
...
-- Create triggers for updated_at columns (safe - with exception handling)
DO $$ BEGIN
...
-- =====================================================
-- SEED DATA (ALL COLUMNS NOW EXIST!)
-- =====================================================
...
-- Insert sample testimonials (NOW with rating and featured columns!)
...
BEGIN
    ...
    RAISE NOTICE 'Missing columns added: user_profiles.role, testimonials.rating, testimonials.featured';
    RAISE NOTICE 'RLS policies enabled for all tables';
    RAISE NOTICE 'Indexes created for optimal performance';
    RAISE NOTICE 'Triggers set up for updated_at columns';
    RAISE NOTICE 'Seed data inserted for testing';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'NEXT STEPS:';
    RAISE NOTICE '1. Create an admin user with: UPDATE user_profiles SET role = ''admin'' WHERE email = ''your-email@example.com'';';
    RAISE NOTICE '2. Test your frontend with the new database schema';
    RAISE NOTICE '3. Access admin dashboard at /admin';
    RAISE NOTICE '==============================================';
END $$;