-- =====================================================
-- COMPLETE MIGRATION SCRIPT FOR KIDSPLAY CONNECT (SAFE)
-- =====================================================
...
-- Add rating column if it doesn't exist (MUST happen before any inserts)
ALTER TABLE testimonials ADD COLUMN IF NOT EXISTS rating INTEGER;

-- Add featured column if it doesn't exist (MUST happen before any inserts)
...
-- =====================================================
-- COLUMN ADDITIONS (MUST HAPPEN BEFORE INDEXES!)
-- =====================================================

-- Add any missing columns to existing tables before creating indexes
-- This ensures all columns exist before indexes reference them

-- No additional columns needed for other tables at this time
...
-- Create triggers for updated_at columns (safe - no drop operations)
